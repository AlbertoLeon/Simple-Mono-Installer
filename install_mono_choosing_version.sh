#!/bin/bash -e
echo -e "What version of Mono do you want to install?"
read version
echo "You will go to install Mono $version";
TOPDIR=$(pwd)
...
PACKAGES=("mono-$version"
"libgdiplus-2.10.9"
"gtk-sharp-2.12.11"
"xsp-2.10.2"
"mod_mono-2.10")

URLS=("http://download.mono-project.com/sources/mono/mono-3.0.3.tar.bz2"
...
echo
echo "installing mono packages in custom directory $PREFIX"
echo
